...
|---|---|---|
| Nivel 1 — País | Selector de país (Chile por defecto / Perú / Colombia) en tabs superiores; cambia todo el contexto del panel. Marcadores circulares por mall activo. | ARQ-05, DAT-11, ARQ-07 |
...
| Tarjeta Costo [UF] | Costo acumulado del período. Variación % vs. período anterior. Moneda seleccionable (UF/CLP/USD/PEN/COP) según país del nivel activo. | DAT-22, FIN-07 |
...
|---|---|---|
| País (selector de tab) | Chile / Perú / Colombia | Chile |
