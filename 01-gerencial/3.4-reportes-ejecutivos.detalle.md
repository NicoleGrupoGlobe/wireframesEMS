...
### Configuración y secciones en un solo formulario · vista previa a la derecha
Todo lo que define el informe —alcance, período, comparación, métrica, formato y las secciones a incluir (checkboxes)— vive en un único contenedor de formulario, en vez de repartirse en tarjetas separadas. La vista previa se ubica a la derecha para dar feedback inmediato de lo que se generará y las acciones (Generar / Programar) se consolidan en el header. Así el gerente arma el reporte de arriba abajo en una sola columna, sin saltar entre contenedores.

*Principio de usabilidad: Agrupar lo que se decide junto; feedback inmediato; una sola tarea, un solo lugar.*
